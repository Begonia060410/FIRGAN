clc
clear all
names = {'DenseFuse', 'RFN-Nest', 'FusionGAN', 'SeAFusion', 'PIAFusion', 'IFCNN', 'PMGI', 'SDNet', 'U2Fusion','TarDal','SPDFusion','ATGAN','ATSpect_notbrisque','ATSpectonvis','Atgan_shuffle','ATGAN_shuffe_spect'};
